...
#include <JeeLib.h>
#include <String.h>
SoftwareSerial mySerial(8,7);//pins to serial communication
...
String idvariable = "575e73b076254201f7b46502";                                     //ID of your variable
void setup()
{
...
mySerial.println("AT+CLTS=1");
 ...
 Serial.println(hour);
     ...
     Serial.println("Sending to Ubidots Value="+ String(value));
